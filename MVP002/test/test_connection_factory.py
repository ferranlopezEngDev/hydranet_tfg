...
class ConnectionFactoryTests(unittest.TestCase):
    ...
    def test_builtin_type_creates_expected_connection(self) -> None:
        ...
        self.assertIn("factor_polynomial", list_connection_types())
    ...
    def test_factor_polynomial_specs_round_trip_for_builtin_type(self) -> None:
        spec = {
        ...
        self.assertIsInstance(connection, FactorPolynomialConnection)
        self.assertEqual(exportedSpec["type"], "factor_polynomial")
        self.assertEqual(exportedSpec["params"]["constantCoefficient"], 1.0)
        self.assertEqual(exportedSpec["params"]["coefficients"], [-0.5, 0.25])
        self.assertEqual(exportedSpec["params"]["exponents"], [1.0, 2.0])
