"""Tkinter application bootstrap for Hydranet MVP002."""
...
class HydranetGuiApplication:
    """Own the root window lifecycle for the MVP002 desktop app."""

    def __init__(
        self,
        *,
        title: str = "Hydranet MVP002",
...
def _print_help() -> None:
    ...
    print("Hydranet MVP002 GUI")
    print("Usage: python src/main.py")
    print("The CLI entry point was removed in MVP002.")
