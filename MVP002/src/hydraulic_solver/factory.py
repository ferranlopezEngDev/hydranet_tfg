...
def _serialize_factor_polynomial(connection: Connection) -> dict[str, object]:
    factorPolynomial = connection
    return {
        "constantCoefficient": getattr(
            factorPolynomial,
            "constantCoefficient",
        ),
        "coefficients": list(getattr(factorPolynomial, "coefficients")),
        "exponents": list(getattr(factorPolynomial, "exponents")),
    }
...
_CONNECTION_REGISTRATIONS: dict[str, _ConnectionRegistration] = {
    ...
    "factor_polynomial": _ConnectionRegistration(
        ...
        serializer=_serialize_factor_polynomial,
    ),
}
