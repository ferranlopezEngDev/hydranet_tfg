...
class Node(Parameterized):
    ...
    PARAMETERS = {
        "piezometricHead": ParameterSpec(
            ...
            default=0.0,
            required=False,
            description="Piezometric head stored at the node.",
        ...
        "elevation": ParameterSpec(
            ...
            default=0.0,
            required=False,
            description="Geometric elevation of the node.",
        ...
        "externalFlow": ParameterSpec(
            ...
            default=0.0,
            required=False,
            description="External flow, positive when it leaves the node.",
        ...
        "isBoundary": ParameterSpec(
            ...
            default=False,
            required=False,
            description="Whether the piezometric head is prescribed.",
