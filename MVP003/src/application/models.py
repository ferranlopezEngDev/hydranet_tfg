...
class SolverInfo:
    ...
    supports_solver_options: bool = False
...
class PerformanceMetrics:
    """Normalized performance and convergence metrics for one execution."""
    ...
    unknown_head_count: int = 0
    solved_node_count: int = 0
    residual_count: int = 0
    max_residual_abs: float = 0.0
    residual_l2_norm: float = 0.0
    nfev: int | None = None
    njev: int | None = None
    nit: int | None = None
